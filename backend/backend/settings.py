...
# Set default environment variables for AI backends (development)
...
# Additional CORS settings for AI endpoints
CORS_ALLOW_HEADERS = [
    'accept',
    'accept-encoding',
    'authorization',
...
# CSRF exempt paths for front end and AI endpoints
...
# REST Framework settings for AI endpoints
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',
    ],
    'DEFAULT_AUTHENTICATION_CLASSES': [],
    'DEFAULT_TIMEOUT': 300,  # 5 minutes for long-running operations
}
...
# Custom timeout for scraping operations
